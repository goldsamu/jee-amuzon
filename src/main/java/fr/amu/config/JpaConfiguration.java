...
/**
 * JPA est une spécification, nous avons besoin d'une implémentation du
 * PersistenceUnit. Ici nous choisissons celle de eclipse link : import
 * org.eclipse.persistence.config.PersistenceUnitProperties;
 * 
 * @author gael
 *
 */
@Configuration // annotation indiquant àSpring une configuration du contexte général. On
				// utilise les outils d'autoconfiguration de spring boot JpaBaseConfiguration
				// etc.
